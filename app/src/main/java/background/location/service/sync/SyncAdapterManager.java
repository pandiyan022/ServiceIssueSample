...
public class SyncAdapterManager {
    public static final String AUTHORITY = "background.location.service.provider";
    public static final String ACCOUNT_TYPE = "background.location.service";
